...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-14 px-5 text-left align-middle font-semibold text-foreground/80 [&:has([role=checkbox])]:pr-0 uppercase text-xs tracking-wider",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn(
      "px-5 py-4 align-middle [&:has([role=checkbox])]:pr-0 text-foreground/90",
      className
    )}
    {...props}
  />
